...
Description: """This is a profile on the DocumentReference resource. It is used to link resources (such as Advance Directives) to a copy of the original document (usually in PDF format), that a resource is based on. """
* ^version = "0.1.0"
* ^status = #active
